                                ...
                                <tr>
                                    <th scope="row">
                                        <?php if($post->image_path && $post->user_id === auth()->id()): ?>
                                            <img src="<?php echo e(route('post.image', ['post' => $post->id])); ?>" alt="Image"
                                                 height="75" width="75">
                                        <?php else: ?>
                                            <?php echo e($post->id); ?>
                                    ...
                                    <td>
                                        <?php if (app(\Illuminate\Contracts\Auth\Access\Gate::class)->check('view posts')): ?>
                                            <a href="<?php echo e(route('post.show', ['post' => $post->id])); ?>"
                                               class="btn btn-sm btn-success">Anzeigen</a>
                                        <?php endif; ?>
                                        <a href="<?php echo e(route('post.edit', ['id' => $post->id])); ?>"
                                           class="btn btn-sm btn-primary">Bearbeiten</a>
                                        <a href="<?php echo e(route('post.image', ['post' => $post->id])); ?>"
                                           class="btn btn-sm btn-primary" target="_blank">Bild</a>
                                        <form action="<?php echo e(route('post.destroy')); ?>" method="POST"
                                              onsubmit="return confirm('Möchtest du den Post wirklich löschen?');">
                                            <?php echo csrf_field(); ?>
